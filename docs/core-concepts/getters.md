...
<VideoComponent href="https://masteringpinia.com/lessons/the-3-pillars-of-pinia-getters" title="通过 Pinia 作者的官方视频课程掌握更多内容"/>
...
你可以使用[前一节的 state](./state.html#options-api) 中的 `mapState()` 函数来将其映射为 getters：
